/**
 * The post card editor's view of the API.
 *
 * Two things cross the wire and they are deliberately kept apart, exactly as the
 * backend keeps them apart:
 *
 *  - **Geometry** (`PostCardTemplate`) — where `photo_2` sits, in inches from
 *    the top-left of the trimmed panel. Owned by `PostCardCatalogue`, fetched
 ...
 *    how it is panned and zoomed. Owned by `PostCard#design_config`, held in
