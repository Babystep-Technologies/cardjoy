...
// Mirrors Mutations::SendPostCard::NO_PROOF_ERROR / STALE_PROOF_ERROR.
...
// Mirrors Mutations::SendPostCard::UNAVAILABLE_ERROR.
const UNAVAILABLE_FRAGMENT = 'Sending cards by post is unavailable';
// Mirrors SendPostCard#check_balance!, which spells the amounts in cents.
...
export function classifySendError(message: string): SendFailure {
  ...
  // SendPostCard#recipient_errors) — an address that stopped being
