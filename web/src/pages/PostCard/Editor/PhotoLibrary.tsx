...
import { UPLOAD_POST_CARD_PHOTO } from '../queries';
import type { EditorOptions, PostCardPhoto } from '../types';
...
interface PhotoLibraryProps {
  ...
  onUploaded: (photo: PostCardPhoto) => void;
  ...
  const handleFiles = async (files: FileList | null) => {
    ...
    try {
      for (const file of queued) {
        ...
        const payload = result.data?.uploadPostCardPhoto;
