/**
 * The post card editor: a left rail of controls, a large centred preview, and
 * a front/back toggle.
 *
...
interface EditorProps {
  ...
  onTemplateChange: (template: PostCardTemplate, next: DesignConfig, dropped: string[]) => void;
  onPhotoUploaded: (photo: PostCardPhoto) => void;
...
export const Editor: React.FC<EditorProps> = ({
  ...
  const handleTemplateSelect = (next: PostCardTemplate) => {
