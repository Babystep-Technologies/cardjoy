...
class ActionDispatch::Routing::Mapper
  # source://actionpack/8.1.2/lib/action_dispatch/routing/mapper.rb#2530
  ...
  class << self
    # source://actionpack/8.1.2/lib/action_dispatch/routing/mapper.rb#27
    def backtrace_cleaner; end

    # source://actionpack/8.1.2/lib/action_dispatch/routing/mapper.rb#27
    def backtrace_cleaner=(val); end

    # source://actionpack/8.1.2/lib/action_dispatch/routing/mapper.rb#407
    def normalize_name(name); end

    # source://actionpack/8.1.2/lib/action_dispatch/routing/mapper.rb#392
    def normalize_path(path); end

    # source://actionpack/8.1.2/lib/action_dispatch/routing/mapper.rb#26
...
class ActionDispatch::Routing::RouteSet
  ...
  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#386
  def initialize(config = T.unsafe(nil)); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#674
  def add_polymorphic_mapping(klass, options, &block); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#643
  def add_route(mapping, name); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#678
  def add_url_helper(name, options, &block); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#417
  def api_only?; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#464
  def append(&block); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#903
  def call(env); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#488
  def clear!; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#438
  def default_env; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#421
  def default_scope; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#425
  def default_scope=(new_default_scope); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#354
  def default_url_options; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#354
  def default_url_options=(_arg0); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#509
  def define_mounted_helper(name, script_namer = T.unsafe(nil)); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#353
  def disable_clear_and_finalize; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#353
  def disable_clear_and_finalize=(_arg0); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#457
  def draw(&block); end
  ...
  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#406
  def eager_load!; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#639
  def empty?; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#355
  def env_key; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#818
  def extra_keys(options, recall = T.unsafe(nil)); end

  # source://devise//lib/devise/rails/routes.rb#8
  def finalize!; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#846
  def find_script_name(options); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#352
  def formatter; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#352
  def formatter=(_arg0); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#29
  def from_requirements(requirements); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#822
  def generate_extras(options, recall = T.unsafe(nil)); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#536
  def generate_url_helpers(supports_path); end

  def inspect; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#505
  ...
  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#842
  def optimize_routes_generation?; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#850
  def path_for(options, route_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#355
  def polymorphic_mappings; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#468
  def prepend(&block); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#909
  def recognize_path(path, environment = T.unsafe(nil)); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#924
  def recognize_path_with_request(req, path, extras, raise_on_missing: T.unsafe(nil)); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#413
  def relative_url_root; end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#429
  ...
  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#855
  def url_for(options, route_name = T.unsafe(nil), url_strategy = T.unsafe(nil), method_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#528
  def url_helpers(supports_path = T.unsafe(nil)); end

  private

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#472
  def eval_block(block); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#833
  def generate(route_name, options, recall = T.unsafe(nil), method_name = T.unsafe(nil)); end

  # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#433
  def make_request(env); end

  class << self
    # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#359
    def default_resources_path_names; end

    # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#363
...
class Devise::FailureApp < ::ActionController::Metal
  ...
  class << self
    ...
    # source://actionpack/8.1.2/lib/action_dispatch/routing/route_set.rb#610
    def _routes; end
