...
module ActiveStorageValidations::ASVAnalyzable
  ...
  # source://active_storage_validations//lib/active_storage_validations/shared/asv_analyzable.rb#74
  ...
  # source://active_storage_validations//lib/active_storage_validations/shared/asv_analyzable.rb#82
  def content_type_analyzer_for(attachable); end

  # source://active_storage_validations//lib/active_storage_validations/shared/asv_analyzable.rb#78
  ...
  # source://active_storage_validations//lib/active_storage_validations/shared/asv_analyzable.rb#55
  ...
  # source://active_storage_validations//lib/active_storage_validations/shared/asv_analyzable.rb#51
  def pdf_analyzer_for(attachable); end

  # source://active_storage_validations//lib/active_storage_validations/shared/asv_analyzable.rb#70
...
module ActiveStorageValidations::ASVErrorable
  ...
  # source://active_storage_validations//lib/active_storage_validations/shared/asv_errorable.rb#39
  def get_filename(file); end

  # source://active_storage_validations//lib/active_storage_validations/shared/asv_errorable.rb#55
  def set_nested_error(record, error); end

  # @return [Boolean]
  #
  # source://active_storage_validations//lib/active_storage_validations/shared/asv_errorable.rb#49
  def updating_through_parent?(record); end
end
