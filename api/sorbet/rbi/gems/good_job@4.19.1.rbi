...
module ActiveJob
  class << self
    # source://activejob/8.1.2/lib/active_job/queue_adapter.rb#7
    def adapter_name(adapter); end

    # source://activejob/8.1.2/lib/active_job/deprecator.rb#4
    def deprecator; end

    # source://activejob/8.1.2/lib/active_job/gem_version.rb#5
    def gem_version; end

    # source://activejob/8.1.2/lib/active_job/enqueuing.rb#14
    def perform_all_later(*jobs); end

    # source://activejob/8.1.2/lib/active_job.rb#60
    def verbose_enqueue_logs; end

    # source://activejob/8.1.2/lib/active_job.rb#60
    def verbose_enqueue_logs=(_arg0); end

    # source://activejob/8.1.2/lib/active_job/version.rb#7
    def version; end

    private

    # source://activejob/8.1.2/lib/active_job/instrumentation.rb#6
...
module ActiveJob::QueueAdapters
  class << self
    # source://activejob/8.1.2/lib/active_job/queue_adapters.rb#134
    def lookup(name); end
  end
end
...
module GoodJob
  ...
  # source://good_job//lib/good_job.rb#132
  ...
  # source://good_job//lib/good_job.rb#110
  def handled_exceptions=(val); end
  ...
  class << self
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#201
    ...
    #
    # source://good_job//lib/good_job.rb#229
    ...
    # @return [Boolean]
    #
    # source://good_job//lib/good_job.rb#356
    def cli?; end
    ...
    #
    # source://good_job//lib/good_job.rb#307
    def deprecator; end
    ...
    def handled_exception_classes; end
    ...
    # @return [Boolean]
    #
    # source://good_job//lib/good_job.rb#317
    def migrated?; end
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#326
    def pause(queue: T.unsafe(nil), job_class: T.unsafe(nil)); end

    # Get a list of all paused queues and job classes
    #
    # @return [Hash] Hash with :queues, :job_classes, :labels arrays of paused items
    #
    # source://good_job//lib/good_job.rb#350
    def paused(type = T.unsafe(nil)); end
    ...
    # @return [Boolean]
    #
    # source://good_job//lib/good_job.rb#344
    def paused?(queue: T.unsafe(nil), job_class: T.unsafe(nil), label: T.unsafe(nil)); end
    ...
    # source://railties/8.1.2/lib/rails/engine.rb#412
    def railtie_helpers_paths; end

    # source://railties/8.1.2/lib/rails/engine.rb#395
    def railtie_namespace; end

    # source://railties/8.1.2/lib/rails/engine.rb#416
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#189
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#172
    ...
    # source://railties/8.1.2/lib/rails/engine.rb#401
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#335
    def unpause(queue: T.unsafe(nil), job_class: T.unsafe(nil), label: T.unsafe(nil)); end

    # source://railties/8.1.2/lib/rails/engine.rb#408
    ...
    # @return [Boolean]
    #
    # source://good_job//lib/good_job.rb#297
    def v4_ready?; end
  end
end
...
module GoodJob::ActiveJobExtensions::Concurrency
  ...
  #
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#343
  ...
  #
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#357
  ...
  # @return [Object] concurrency key
  #
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#337
  ...
  module GeneratedClassMethods
    ...
    def good_job_concurrency_config?; end
    def good_job_concurrency_rules; end
    def good_job_concurrency_rules=(value); end
    def good_job_concurrency_rules?; end
...
module GoodJob::ActiveJobExtensions::Concurrency::ClassMethods
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#312
  def good_job_concurrency_rule(label: T.unsafe(nil), key: T.unsafe(nil), total_limit: T.unsafe(nil), enqueue_limit: T.unsafe(nil), perform_limit: T.unsafe(nil), enqueue_throttle: T.unsafe(nil), perform_throttle: T.unsafe(nil)); end

  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#289
  def good_job_control_concurrency_with(total_limit: T.unsafe(nil), enqueue_limit: T.unsafe(nil), perform_limit: T.unsafe(nil), enqueue_throttle: T.unsafe(nil), perform_throttle: T.unsafe(nil), key: T.unsafe(nil)); end
end
...
# source://good_job//lib/good_job/active_job_extensions/concurrency.rb#207
module GoodJob::ActiveJobExtensions::Concurrency::Prepends
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#208
...
class GoodJob::ActiveJobExtensions::Concurrency::Rule
  ...
  #
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#21
  def initialize(config); end

  # Returns the value of attribute enqueue_limit.
  #
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#19
  def enqueue_limit; end

  # Returns the value of attribute enqueue_throttle.
  #
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#19
  def enqueue_throttle; end

  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#35
  def evaluate(job, stage); end

  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#31
  def key; end
  ...
  def check_enqueue(limit, throttle, job, key, label, enqueue_limit_flag: T.unsafe(nil)); end

  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#158
  def check_perform(limit, throttle, job, key, label); end

  # @return [Boolean]
  #
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#57
  def key_explicit?; end

  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#94
  def query_scope(label, key); end

  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#61
  def resolve_key(job); end

  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#72
  def resolve_label(job); end

  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#78
  def resolve_limit(job, value); end

  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#86
  def resolve_throttle(job, value); end
end
...
class GoodJob::Adapter
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#287
  ...
  # @return [GoodJob::Job]
  #
  # source://good_job//lib/good_job/adapter.rb#168
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#263
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#271
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/adapter.rb#277
  def start_async; end
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#232
  def stopping?; end
  ...
  #
  # source://good_job//lib/good_job/adapter.rb#302
  def perform_inline(job, notify: T.unsafe(nil), already_claimed: T.unsafe(nil), advisory_unlock: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#293
...
class GoodJob::Adapter::InlineBuffer
  ...
  # source://activesupport/8.1.2/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#74
  def current_buffer; end

  # source://activesupport/8.1.2/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#116
  ...
  class << self
    ...
    #
    # source://activesupport/8.1.2/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#49
    def current_buffer; end
    ...
    # @return [GoodJob::Adapter::InlineBuffer, nil]
    #
    # source://activesupport/8.1.2/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#108
    def current_buffer=(obj); end
...
module GoodJob::AdvisoryLockable
  ...
  def advisory_lock(key: T.unsafe(nil), function: T.unsafe(nil), connection: T.unsafe(nil), &block); end
  def advisory_lock!(key: T.unsafe(nil), function: T.unsafe(nil), connection: T.unsafe(nil)); end
  def advisory_locked?(key: T.unsafe(nil)); end
  def advisory_unlock(key: T.unsafe(nil), function: T.unsafe(nil), connection: T.unsafe(nil)); end
  ...
  def with_advisory_lock(key: T.unsafe(nil), function: T.unsafe(nil), &block); end

  class << self
    def hash_function; end
    def hash_function=(value); end
  end
...
GoodJob::AdvisoryLockable::ADVISORY_LOCK_COUNTS = T.let(T.unsafe(nil), GoodJob::AdvisoryLockable::AdvisoryLockCounter)
GoodJob::AdvisoryLockable::AREL_TABLE_NEW_KWARGS = T.let(T.unsafe(nil), FalseClass)
...
class GoodJob::AdvisoryLockable::AdvisoryLockCounter
  ...
  def [](conn); end
  def []=(conn, value); end
  def clear_session_locks(conn); end
  def counts_for(conn, key); end
  def delete(conn); end
  def prune(conn); end
  def record_lock(conn, key, cte: T.unsafe(nil), xact: T.unsafe(nil)); end
  def record_unlock(conn, key); end

  private

  def oid(conn); end
  def prune_stale_entries; end
end

module GoodJob::AdvisoryLockable::ClassMethods
  def _advisory_lockable_column; end
  def _quoted_table_name_string(name = T.unsafe(nil)); end
  def advisory_lock(column: T.unsafe(nil), function: T.unsafe(nil), select_limit: T.unsafe(nil), connection: T.unsafe(nil), unlock_session: T.unsafe(nil), &block); end
  def advisory_lock_bigint_sql(value_sql); end
  def advisory_lock_classid_sql(value_sql); end
  def advisory_lock_key(key, function: T.unsafe(nil), connection: T.unsafe(nil)); end
  def advisory_lock_objid_sql(value_sql); end
  def advisory_locked_key?(key); end
  def advisory_unlock_key(key, function: T.unsafe(nil), connection: T.unsafe(nil)); end
  def advisory_unlock_key!(key, function: T.unsafe(nil), connection: T.unsafe(nil)); end
  def advisory_unlock_session(connection: T.unsafe(nil)); end
  def advisory_unlockable_function(function = T.unsafe(nil)); end
  def owns_advisory_lock_key?(key, connection: T.unsafe(nil)); end
  def pg_or_jdbc_query(query); end
  def prune_advisory_locks(conn); end
  def record_advisory_lock(conn, key, cte: T.unsafe(nil), xact: T.unsafe(nil)); end
  def record_advisory_unlock(conn, key); end
  def supports_cte_materialization_specifiers?; end
  def with_advisory_lock(**kwargs, &block); end

  private

  def _advisory_unlock_key_once(key, function:, connection:); end
  def arel_table_for(name); end
end
...
class GoodJob::ApplicationController < ::ActionController::Base
  ...
  # source://actionview/8.1.2/lib/action_view/layouts.rb#328
...
class GoodJob::Batch
  ...
  class << self
    def _build_and_partition_jobs(batch_job_pairs, current_time); end
    def _build_batch_rows(batch_job_pairs, current_time); end
    def _insert_jobs(bulkable_entries, active_jobs_by_job_id); end
    def _mark_batches_persisted(batch_job_pairs, batch_rows, current_time); end
    def _send_notifications(jobs, active_jobs_by_job_id, adapter); end
    def _send_notify?(active_job); end
    ...
    def enqueue(active_jobs = T.unsafe(nil), **properties, &block); end
    def enqueue_all(batch_job_pairs); end
    def find(id); end
    def primary_key; end
...
class GoodJob::BatchRecord < ::GoodJob::BaseRecord
  ...
  # source://activerecord/8.1.2/lib/active_record/autosave_association.rb#162
  ...
  class << self
    ...
    # source://activerecord/8.1.2/lib/active_record/scoping/named.rb#174
...
module GoodJob::BatchRecord::GeneratedAssociationMethods
  # source://activerecord/8.1.2/lib/active_record/associations/builder/collection_association.rb#62
  def callback_job_ids; end

  # source://activerecord/8.1.2/lib/active_record/associations/builder/collection_association.rb#74
  def callback_job_ids=(ids); end

  # source://activerecord/8.1.2/lib/active_record/associations/builder/association.rb#104
  def callback_jobs; end

  # source://activerecord/8.1.2/lib/active_record/associations/builder/association.rb#114
...
class GoodJob::CLI < ::Thor
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/cli.rb#161
  def cleanup_preserved_jobs; end

  # source://good_job//lib/good_job/cli.rb#174
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/cli.rb#110
  def start; end

  class << self
    # @return [Boolean]
    #
    # source://good_job//lib/good_job/cli.rb#43
...
class GoodJob::Capsule
  ...
  # source://good_job//lib/good_job/capsule.rb#114
  ...
  def process_id(*_arg0, **_arg1, &_arg2); end
  ...
  # source://good_job//lib/good_job/capsule.rb#121
  def configuration; end

  # @return [Boolean]
  #
  # source://good_job//lib/good_job/capsule.rb#125
...
class GoodJob::CapsuleTracker
  ...
  # source://good_job//lib/good_job/capsule_tracker.rb#190
  ...
  # source://good_job//lib/good_job/capsule_tracker.rb#199
  def ns_reset; end

  # source://good_job//lib/good_job/capsule_tracker.rb#195
  def reset; end
  ...
  # source://good_job//lib/good_job/capsule_tracker.rb#162
...
class GoodJob::Configuration
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#434
  ...
  #
  # source://good_job//lib/good_job/configuration.rb#290
  def cleanup_interval_jobs; end
  ...
  # @return [Integer, Boolean, nil]
  #
  # source://good_job//lib/good_job/configuration.rb#309
  def cleanup_interval_seconds; end
  ...
  # source://good_job//lib/good_job/configuration.rb#442
  def dequeue_query_sort; end

  # Whether to run cron
  #
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#211
  def enable_cron; end
  ...
  # source://good_job//lib/good_job/configuration.rb#362
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#391
  def enable_pauses; end
  ...
  # @return [Hash]
  #
  # source://good_job//lib/good_job/configuration.rb#66
  def env; end
  ...
  # @return [Symbol]
  #
  # source://good_job//lib/good_job/configuration.rb#112
  def execution_mode; end
  ...
  # @return [Boolean, nil]
  #
  # source://good_job//lib/good_job/configuration.rb#412
  ...
  # @return [Symbol]
  #
  # source://good_job//lib/good_job/configuration.rb#401
  def lock_strategy; end

  # source://good_job//lib/good_job/configuration.rb#424
  ...
  # @return [Hash]
  #
  # source://good_job//lib/good_job/configuration.rb#60
  def options; end
  ...
  # @return [String]
  #
  # source://good_job//lib/good_job/configuration.rb#154
  ...
  # source://good_job//lib/good_job/configuration.rb#104
  def validate!; end

  private

  # source://good_job//lib/good_job/configuration.rb#448
  ...
  class << self
    ...
    # @return [Integer]
    #
    # source://good_job//lib/good_job/configuration.rb#71
    def total_estimated_threads(warn: T.unsafe(nil)); end

    # @raise [ArgumentError]
    #
    # source://good_job//lib/good_job/configuration.rb#53
    def validate_dequeue_query_sort(dequeue_query_sort); end

    # @raise [ArgumentError]
    #
    # source://good_job//lib/good_job/configuration.rb#49
...
#
# source://good_job//lib/good_job/configuration.rb#41
GoodJob::Configuration::DEFAULT_ENABLE_PAUSES = T.let(T.unsafe(nil), FalseClass)
...
GoodJob::Configuration::DEFAULT_QUEUE_SELECT_LIMIT = T.let(T.unsafe(nil), Integer)
...
GoodJob::Configuration::DEQUEUE_QUERY_SORTS = T.let(T.unsafe(nil), Array)
...
#
# source://good_job//lib/good_job/configuration.rb#47
GoodJob::Configuration::LOCK_STRATEGIES = T.let(T.unsafe(nil), Array)
...
class GoodJob::CronEntry
  ...
  # source://activesupport/8.1.2/lib/active_support/callbacks.rb#70
  def __callbacks; end

  # source://activesupport/8.1.2/lib/active_support/callbacks.rb#910
  def _run_validate_callbacks; end

  # source://activesupport/8.1.2/lib/active_support/callbacks.rb#915
  def _run_validate_callbacks!(&block); end

  # source://activesupport/8.1.2/lib/active_support/callbacks.rb#927
  def _validate_callbacks; end

  # source://activemodel/8.1.2/lib/active_model/validations.rb#50
  def _validators; end
  ...
  # source://activemodel/8.1.2/lib/active_model/naming.rb#254
  def model_name(&_arg0); end

  def next_at(previously_at: T.unsafe(nil)); end

  # source://activemodel/8.1.2/lib/active_model/conversion.rb#32
  ...
  class << self
    ...
    # source://activesupport/8.1.2/lib/active_support/callbacks.rb#919
    def _validate_callbacks; end

    # source://activesupport/8.1.2/lib/active_support/callbacks.rb#923
    ...
    def last_jobs_by_key(cron_entries); end
...
module GoodJob::CurrentThread
  ...
  class << self
    ...
    #
    # source://good_job//lib/good_job/current_thread.rb#101
    ...
    #
    # source://good_job//lib/good_job/current_thread.rb#106
    def process_id; end
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job/current_thread.rb#86
    ...
    # @yield [self]
    #
    # source://good_job//lib/good_job/current_thread.rb#118
    def within; end
  end
end
...
#
# source://good_job//lib/good_job/engine.rb#7
...
GoodJob::ErrorEvents::DISCARDED = T.let(T.unsafe(nil), Symbol)
GoodJob::ErrorEvents::HANDLED = T.let(T.unsafe(nil), Symbol)
GoodJob::ErrorEvents::INTERRUPTED = T.let(T.unsafe(nil), Symbol)
GoodJob::ErrorEvents::RETRIED = T.let(T.unsafe(nil), Symbol)
GoodJob::ErrorEvents::RETRY_STOPPED = T.let(T.unsafe(nil), Symbol)
GoodJob::ErrorEvents::UNHANDLED = T.let(T.unsafe(nil), Symbol)
...
class GoodJob::Execution < ::GoodJob::BaseRecord
  ...
  class << self
    # source://activerecord/8.1.2/lib/active_record/enum.rb#233
...
module GoodJob::Execution::GeneratedAssociationMethods
  # source://activerecord/8.1.2/lib/active_record/associations/builder/singular_association.rb#36
  def build_job(*args, &block); end

  # source://activerecord/8.1.2/lib/active_record/associations/builder/singular_association.rb#42
  def create_job(*args, &block); end

  # source://activerecord/8.1.2/lib/active_record/associations/builder/singular_association.rb#48
  def create_job!(*args, &block); end
  ...
  # source://activerecord/8.1.2/lib/active_record/associations/builder/belongs_to.rb#155
  def job_changed?; end

  # source://activerecord/8.1.2/lib/active_record/associations/builder/belongs_to.rb#161
  def job_previously_changed?; end

  # source://activerecord/8.1.2/lib/active_record/associations/builder/singular_association.rb#19
  def reload_job; end

  # source://activerecord/8.1.2/lib/active_record/associations/builder/singular_association.rb#25
  def reset_job; end
end
...
class GoodJob::ExecutionResult
  def initialize(value:, active_job: T.unsafe(nil), handled_error: T.unsafe(nil), unhandled_error: T.unsafe(nil), error_event: T.unsafe(nil), unexecutable: T.unsafe(nil), retried_job: T.unsafe(nil)); end
...
GoodJob::Filterable::MAX_SEARCH_COLUMN_CHARS = T.let(T.unsafe(nil), Integer)
...
#
# source://good_job//lib/good_job/interrupt_error.rb#8
...
#
# source://good_job//lib/good_job/interrupted_error.rb#7
class GoodJob::InterruptedError < ::GoodJob::InterruptError; end
...
class GoodJob::Job < ::GoodJob::BaseRecord
  ...
  include ::GoodJob::AdvisoryLockable
  include ::GoodJob::Job::Lockable
  include ::GoodJob::ErrorEvents
  include ::GoodJob::Filterable
  include ::GoodJob::Reportable
  include ::GoodJob::Job::LockTypeAccessor
  extend ::GoodJob::AdvisoryLockable::ClassMethods
  extend ::GoodJob::Job::Lockable::ClassMethods
  extend ::GoodJob::Filterable::ClassMethods
  ...
  def job_state; end
  def number; end
  def perform(lock_id:, already_claimed: T.unsafe(nil)); end
  def queue_latency; end
  ...
  def preserve_job_record?(result); end
  def reset_batch_values(&block); end
  def with_appropriate_lock; end
  ...
  class << self
    ...
    # source://activemodel/8.1.2/lib/active_model/callbacks.rb#144
    def after_perform(*args, **options, &block); end

    # source://activemodel/8.1.2/lib/active_model/callbacks.rb#144
    def after_perform_unlocked(*args, **options, &block); end

    # source://activemodel/8.1.2/lib/active_model/callbacks.rb#137
    def around_perform(*args, **options, &block); end

    # source://activemodel/8.1.2/lib/active_model/callbacks.rb#130
    ...
    def defer_after_commit_maybe(good_job_or_active_job_classes); end
    ...
    def effective_lock_strategy(strategy = T.unsafe(nil)); end
    def enqueue(active_job, scheduled_at: T.unsafe(nil), create_with_advisory_lock: T.unsafe(nil), lock_id: T.unsafe(nil), lock_type: T.unsafe(nil)); end
    def enqueue_after_commit?(good_job_or_active_job_classes); end
    ...
    # source://activerecord/8.1.2/lib/active_record/scoping/named.rb#174
    def exclude_paused(*args, **_arg1); end
    ...
    def historic_finished_at_index_migrated?; end
    ...
    # source://activerecord/8.1.2/lib/active_record/scoping/named.rb#174
    def labeled(*args, **_arg1); end

    def lock_type_column_exists?; end
    ...
    def perform_with_hybrid_lock(lock_id:, parsed_queues: T.unsafe(nil)); end
    def perform_with_lock(lock_id:, parsed_queues: T.unsafe(nil), queue_select_limit: T.unsafe(nil), lock_strategy: T.unsafe(nil), &block); end
    def perform_with_skip_locked(lock_id:, parsed_queues: T.unsafe(nil)); end
...
GoodJob::Job::LockTypeAccessor::LOCK_TYPES = T.let(T.unsafe(nil), Hash)

module GoodJob::Job::Lockable
  extend ::ActiveSupport::Concern

  mixes_in_class_methods ::GoodJob::Job::Lockable::ClassMethods
end

module GoodJob::Job::Lockable::ClassMethods
  def with_advisory_lock_claim(select_limit: T.unsafe(nil), &block); end
  def with_hybrid_lock_claim(locked_by_id:, locked_at:, lock_type:, &block); end
  def with_skip_locked_claim(locked_by_id:, locked_at:, lock_type:, &block); end
end
...
class GoodJob::JobsFilter < ::GoodJob::BaseFilter
  ...
  def default_base_query; end
  def filter_by_cron_key(cron_key); end
  def filter_by_finished_since(since); end
  def filter_by_job_class(job_class); end
  def filter_by_label(label); end
  def filter_by_queue_name(queue_name); end
  def filter_by_search_query(query); end
  def filter_by_state(state); end
  def finished_since(finished_since); end
  def query_for_records; end
  def query_is_uuid_and_job_exists?(search_query); end
  def succeeded_count(query); end
end

GoodJob::JobsFilter::UUID_REGEX = T.let(T.unsafe(nil), Regexp)
...
class GoodJob::LogSubscriber < ::ActiveSupport::LogSubscriber
  ...
  # source://good_job//lib/good_job/log_subscriber.rb#279
  def debug(progname = T.unsafe(nil), tags: T.unsafe(nil), &block); end

  # Responds to the +enqueue_concurrency_limit_exceeded.good_job+ notification.
  #
  # @param event [ActiveSupport::Notifications::Event]
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#157
  def enqueue_concurrency_limit_exceeded(event); end

  # Responds to the +enqueue_concurrency_throttle_exceeded.good_job+ notification.
  #
  # @param event [ActiveSupport::Notifications::Event]
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#168
  def enqueue_concurrency_throttle_exceeded(event); end
  ...
  # @return [Logger]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#200
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#188
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#179
  ...
  # @yield [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#250
  ...
  class << self
    ...
    # @return [Logger]
    #
    # source://good_job//lib/good_job/log_subscriber.rb#222
    def logger; end
    ...
    # @return [Array<Logger>]
    #
    # source://good_job//lib/good_job/log_subscriber.rb#214
    def loggers; end
...
class GoodJob::Notifier
  ...
  #
  # source://good_job//lib/good_job/notifier.rb#98
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/notifier.rb#160
  ...
  # @return [true, false, nil]
  #
  # source://good_job//lib/good_job/notifier.rb#109
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/notifier.rb#150
  def restart(timeout: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://good_job//lib/good_job/notifier.rb#91
  def running?; end
  ...
  # source://good_job//lib/good_job/notifier.rb#204
  def create_listen_task(delay: T.unsafe(nil)); end

  # source://good_job//lib/good_job/notifier.rb#296
  def reset_connection_errors; end

  # source://good_job//lib/good_job/notifier.rb#194
  def start; end

  # source://good_job//lib/good_job/notifier.rb#271
  def wait_for_notify; end

  # source://good_job//lib/good_job/notifier.rb#257
  ...
  class << self
    ...
    #
    # source://good_job//lib/good_job/notifier.rb#46
    def instances; end
    ...
    #
    # source://good_job//lib/good_job/notifier.rb#56
...
#
# source://good_job//lib/good_job/notifier.rb#30
...
module GoodJob::Notifier::ProcessHeartbeat
  ...
  #
  # source://good_job//lib/good_job/notifier/process_heartbeat.rb#33
...
module GoodJob::OverridableConnection::ClassMethods
  ...
  # source://good_job//lib/good_job/overridable_connection.rb#22
  def lease_connection; end

  # source://good_job//lib/good_job/overridable_connection.rb#29
  def override_connection(conn); end
end

class GoodJob::PausesController < ::GoodJob::ApplicationController
  def create; end
  def destroy; end
  def index; end
...
class GoodJob::ProbeServer::SimpleHandler
  ...
  # source://good_job//lib/good_job/probe_server/simple_handler.rb#81
...
#
# source://good_job//lib/good_job/safe_state.rb#8
module GoodJob::SafeState
  class << self
    # source://good_job//lib/good_job/safe_state.rb#9
    def [](key); end

    # source://good_job//lib/good_job/safe_state.rb#13
    def []=(key, value); end

    # source://good_job//lib/good_job/safe_state.rb#17
    def delete(key); end

    private

    # source://good_job//lib/good_job/safe_state.rb#25
    def state; end
  end
end
...
class GoodJob::Scheduler
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#250
  def cleanup; end
  ...
  # @return [Hash]
  #
  # source://good_job//lib/good_job/scheduler.rb#209
  def stats; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#190
  def task_observer(time, output, thread_error); end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#226
  def warm_cache; end

  private

  # source://good_job//lib/good_job/scheduler.rb#311
  def cache_count; end

  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#272
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#282
  def create_task(delay = T.unsafe(nil), fanout: T.unsafe(nil)); end

  # Returns the value of attribute executor.
  #
  # source://good_job//lib/good_job/scheduler.rb#269
  def executor; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#301
  ...
  # source://good_job//lib/good_job/scheduler.rb#315
...
class GoodJob::Scheduler::ThreadPoolExecutor < ::Concurrent::ThreadPoolExecutor
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/scheduler.rb#325
...
# @private
#
# source://good_job//lib/good_job/scheduler.rb#340
class GoodJob::Scheduler::TimerSet < ::Concurrent::TimerSet
  # Number of scheduled jobs in the queue
  #
  # @return [Integer]
  #
  # source://good_job//lib/good_job/scheduler.rb#343
...
class GoodJob::Setting < ::GoodJob::BaseRecord
  ...
  class << self
    ...
    def cron_keys_enabled(keys_with_defaults); end
    def pause(queue: T.unsafe(nil), job_class: T.unsafe(nil), label: T.unsafe(nil)); end
    def paused(type = T.unsafe(nil)); end
    def paused?(queue: T.unsafe(nil), job_class: T.unsafe(nil), label: T.unsafe(nil)); end
    def unpause(queue: T.unsafe(nil), job_class: T.unsafe(nil), label: T.unsafe(nil)); end
...
GoodJob::Setting::PAUSES = T.let(T.unsafe(nil), String)
