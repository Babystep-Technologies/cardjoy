...
class ActiveJob::Base
  ...
  # source://activejob/8.1.2/lib/active_job/exceptions.rb#12
  ...
  # source://activejob/8.1.2/lib/active_job/logging.rb#15
  def logger; end

  # source://activejob/8.1.2/lib/active_job/logging.rb#15
  def logger=(val); end

  # source://activejob/8.1.2/lib/active_job/queue_adapter.rb#27
  def queue_adapter(&_arg0); end

  # source://activejob/8.1.2/lib/active_job/queue_name.rb#57
  ...
  class << self
    ...
    # source://activejob/8.1.2/lib/active_job/queue_adapter.rb#25
    def _queue_adapter; end

    # source://activejob/8.1.2/lib/active_job/queue_adapter.rb#25
    def _queue_adapter=(value); end

    # source://activejob/8.1.2/lib/active_job/queue_adapter.rb#24
    def _queue_adapter_name; end

    # source://activejob/8.1.2/lib/active_job/queue_adapter.rb#24
    def _queue_adapter_name=(value); end

    # source://activejob/8.1.2/lib/active_job/test_helper.rb#19
    ...
    # source://activejob/8.1.2/lib/active_job/enqueuing.rb#53
    def enqueue_after_transaction_commit; end

    # source://activejob/8.1.2/lib/active_job/enqueuing.rb#53
    def enqueue_after_transaction_commit=(value); end

    # source://activejob/8.1.2/lib/active_job/logging.rb#26
    ...
    # source://activejob/8.1.2/lib/active_job/queue_priority.rb#49
    def priority; end
    ...
    # source://activejob/8.1.2/lib/active_job/queue_name.rb#55
    def queue_name; end
    ...
    # source://activejob/8.1.2/lib/active_job/queue_name.rb#56
    ...
    # source://activejob/8.1.2/lib/active_job/exceptions.rb#11
