...
class OmniAuth::Strategies::GoogleOauth2 < ::OmniAuth::Strategies::OAuth2
  ...
  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#95
  def build_access_token; end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#95
  def custom_build_access_token; end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#91
  def raw_info; end

  private

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#110
  def callback_url; end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#142
  def client_get_token(verifier, redirect_uri); end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#114
  ...
  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#161
  def get_token_options(redirect_uri = T.unsafe(nil)); end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#146
  def get_token_params; end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#196
  def image_params; end

  # @return [Boolean]
  #
  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#192
  def image_size_opts_passed?; end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#172
  def image_url; end

  # @return [Boolean]
  #
  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#106
  def nil_or_empty?(obj); end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#165
  def prune!(hash); end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#211
  ...
  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#157
  def verified_email; end

  # @raise [CallbackError]
  #
  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#242
  def verify_hd(access_token); end

  # source://omniauth-google-oauth2//lib/omniauth/strategies/google_oauth2.rb#235
