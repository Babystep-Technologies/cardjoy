...
# What it would cost to mail one post card to a set of contacts (issue #147).
#
#   PostCard::MailingQuote.new(card, contacts).call # => Result
#
...
class PostCard::MailingQuote
  ...
  sig { params(card: ::PostCard, contacts: T::Enumerable[::Contact], verifier: T.untyped).void }
