    ...
    def resolve
      {
        ...
        post_cards_last_1_day: ::PostCard.where("created_at >= ?", 1.day.ago).count,
        post_cards_last_7_days: ::PostCard.where("created_at >= ?", 7.days.ago).count,
        post_cards_last_30_days: ::PostCard.where("created_at >= ?", 30.days.ago).count,
        post_cards_last_90_days: ::PostCard.where("created_at >= ?", 90.days.ago).count,
        post_cards_last_180_days: ::PostCard.where("created_at >= ?", 180.days.ago).count,
