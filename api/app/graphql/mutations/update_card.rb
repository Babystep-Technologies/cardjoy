...
module Mutations
  class UpdateCard < BaseMutation
    ...
    def resolve(card_id:, title: nil, recipients: nil, occasion: nil, style_ids: [], cover_image_url: nil, cover_image_file: nil, max_messages: nil, require_login_to_contribute: nil, slug: nil)
