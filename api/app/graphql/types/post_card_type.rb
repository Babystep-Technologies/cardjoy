...
module Types
  class PostCardType < Types::BaseObject
    ...
    # The whole design document. Its shape is owned by PostCard's validator
    ...
    field :photos, [ Types::PostCardPhotoType ], null: false
    ...
    # component. There is no `locked`: a post card takes no contributions, so
    ...
    # card — see Sources::PostCardOrderSummaryByCardId.
    field :order_summary, Types::PostCardOrderSummaryType, null: false,
      description: "How many pieces this card has been mailed as, and how they went."

    def order_summary
      dataloader.with(Sources::PostCardOrderSummaryByCardId).load(object.id)
    end
