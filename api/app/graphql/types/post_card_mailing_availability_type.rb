...
module Types
  ...
  # GeneratePostCardProof and SendPostCard, which return
  ...
  class PostCardMailingAvailabilityType < Types::BaseObject
    description "Whether post cards can currently be proofed and mailed."
