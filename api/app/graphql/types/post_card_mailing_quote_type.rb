...
module Types
  # An advisory price for mailing one post card to a list of contacts (#147).
  #
  ...
  class PostCardMailingQuoteType < Types::BaseObject
    ...
    field :entries, [ Types::PostCardMailingQuoteEntryType ], null: false,
