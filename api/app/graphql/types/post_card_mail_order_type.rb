...
module Types
  ...
  class PostCardMailOrderType < Types::BaseObject
    description "A single post card mailed to a single address."
    ...
    field :recipient_address, Types::PostCardMailRecipientType, null: false,
